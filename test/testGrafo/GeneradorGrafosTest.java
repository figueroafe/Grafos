...
public class GeneradorGrafosTest{
	...
	@Test
	public void generadorNoRegularAl40() throws Exception {
	...
	public void generadorRegularAl50() {
		GeneradorDeGrafos generador = new GeneradorDeGrafos();
		generador.generarGrafoRegularConPorcentajeDeAdyacencia(1000, 50)
				.grabarGrafoIN("IN/Regular/50_porciento_adyacencia.in");
	}

	@Test
	public void generadorRegularAl75() {
		GeneradorDeGrafos generador = new GeneradorDeGrafos();
		generador.generarGrafoRegularConPorcentajeDeAdyacencia(1000, 75)
				.grabarGrafoIN("IN/Regular/75_porciento_adyacencia.in");
	}
